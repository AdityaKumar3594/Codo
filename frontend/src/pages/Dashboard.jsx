        ...
        <div className="min-h-screen bg-black flex items-center justify-center">
            <div className="bg-[#1a1a1a] rounded-2xl p-10 w-full max-w-md flex flex-col items-center gap-6 shadow-2xl">
                ...
                <button
                    onClick={handleLogin}
                    disabled={loading}
                    className="w-full bg-white hover:bg-gray-100 transition-colors text-gray-800 font-medium text-sm py-3 px-5 rounded-lg flex items-center justify-center gap-3 shadow-sm"
                >
                    {/* Google Icon */}
                ...
                <p className="text-gray-600 text-xs text-center">
                    ...
                    <span className="underline cursor-pointer hover:text-gray-400 transition-colors">Terms &amp; Privacy Policy</span>.
                </p>
            </div>
        </div>
    );
